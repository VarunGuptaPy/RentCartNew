            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                    onPressed: () async {
                      await openEditingDialog(
                          'short description', 'Short Info', 'str');
                    },
                    icon: Icon(Icons.edit),
                    color: Colors.red,
                  ),
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                    onPressed: () async {
                      await openEditingDialog(
                          'Rent Per Day', 'SingleDayRent', 'int');
                    },
                    icon: Icon(Icons.edit),
                    color: Colors.red,
                  ),
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                    onPressed: () async {
                      await openEditingDialog(
                          'Rent Per Week', 'SingleWeekRent', 'int');
                    },
                    icon: Icon(Icons.edit),
                    color: Colors.red,
                  ),
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                    onPressed: () async {
                      await openEditingDialog(
                          'Rent Per Month', 'SingleMonthRent', 'int');
                    },
                    icon: Icon(Icons.edit),
                    color: Colors.red,
                  ),
